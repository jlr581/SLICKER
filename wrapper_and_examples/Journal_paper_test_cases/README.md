The test cases in the missing_data, noise and non_linear subdirectories are all from *The Holocene* journal paper, figures 7-9.  Specifically, the test cases are
